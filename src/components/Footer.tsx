        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              La nueva era de la banca digital en Colombia. Abre tu cuenta en minutos,
              sin filas y sin complicaciones.
            </p>
            <div className="flex gap-4">
              {[
                ...
                <a
                  key={social.name}
                  href="#"
                  className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Cuenta personal', 'Cuenta empresarial', 'Tarjeta débito', 'Transferencias', 'Pagos'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Centro de ayuda', 'Contacto', 'FAQ', 'Seguridad', 'Términos'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                    {item}
                  </a>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
            <div className="flex items-center gap-2">
              ...
              <span>Regulado por la Superintendencia Financiera de Colombia</span>
            </div>
            <div className="flex items-center gap-2">
              <span>Protegido por</span>
              <span className="font-semibold text-white">Fogafín</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
            <p>&copy; 2025 DIGIBANK. Todos los derechos reservados.</p>
