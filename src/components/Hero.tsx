...
export default function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white min-h-screen flex items-center">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <div className="inline-block px-4 py-2 bg-blue-500/30 rounded-full text-sm font-medium mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a
                href="#como-funciona"
                className="px-8 py-4 border-2 border-white/30 rounded-full font-semibold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2"
              >
                Ver cómo funciona
                ...
                <div className="w-full h-full bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2.5rem] overflow-hidden relative">
                  ...
                  <div className="p-6 pt-12">
                    <div className="text-center mb-6">
                      <div className="text-2xl font-bold">DIGIBANK</div>
                    ...
                    <div className="bg-white/10 backdrop-blur rounded-2xl p-4">
                      <div className="text-sm font-medium mb-3">Últimos movimientos</div>
                      {[
